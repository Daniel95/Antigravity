...
public class GenerateableTileLibrary : MonoBehaviour {
    ...
    public static bool IsTile(string tileInstanceName) {
        Debug.Log("________ ");
        Debug.Log("levelObjectPrefabName: " + tileInstanceName);
        string levelObjectPrefabName = tileInstanceName.Replace("AutoGenerated ", "");
        int spaceIndex = levelObjectPrefabName.IndexOf(" ");
        if(spaceIndex > 0) {
            levelObjectPrefabName = levelObjectPrefabName.Substring(0, spaceIndex);
        }
        Debug.Log("levelObjectPrefabName: " + levelObjectPrefabName);
