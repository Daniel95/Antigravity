...
public class TileGenerator : MonoBehaviour {
    ...
    public void GenerateTile(Vector2 gridPosition) {
        ...
        if (tile.TileType == TileType.Empty) {
            if(TileGrid.Instance.Contains(gridPosition)) {
    ...
    public void RegenerateAutoGeneratedTiles() {
        ...
        foreach (TileType tileType in autoGeneratedTileTypes) {
            List<Vector2> tileTypeGridPositions = TileGrid.Instance.GetGridPositionsByTileType(tileType);

            tileTypeGridPositions.ForEach(x => TileGrid.Instance.RemoveTile(x));
