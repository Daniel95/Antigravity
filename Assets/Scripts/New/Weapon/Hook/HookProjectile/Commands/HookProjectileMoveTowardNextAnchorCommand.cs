...
public class HookProjectileMoveTowardNextAnchorCommand : Command {
    ...
    [Inject] private HookProjectileMoveTowardsNextAnchorCompletedEvent hookProjectileReachedNextAnchorEvent;
    ...
    protected override void Execute() {
        ...
        moveTowardsRef.Get().StartMoving(nextPoint, hookProjectileReachedNextAnchorEvent);
    }
}